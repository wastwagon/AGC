...
export default async function AdminTaxonomyPage() {
  ...
  return (
    <div>
      ...
      <form action={saveSiteTaxonomy} className="space-y-8 rounded-xl border border-border bg-white p-4 shadow-sm sm:p-8">
        <div>
          ...
          <textarea
            ...
            className="mt-2 w-full rounded-lg border border-border px-3 py-2 font-mono text-sm text-slate-900"
            spellCheck={false}
          />

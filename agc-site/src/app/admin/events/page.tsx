      ...
      <div className="space-y-4">
        {dbEvents.map((event) => {
          ...
          return (
            <div
              key={event.id}
              className="flex flex-wrap items-center justify-between gap-4 rounded-xl border border-border bg-white p-6 shadow-sm"
            >
              <div>
                ...
                {slug && (
                  <>
                    <Link
                      ...
                      className="inline-flex min-h-[44px] items-center gap-1.5 rounded-lg border border-border bg-white px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50"
                    >

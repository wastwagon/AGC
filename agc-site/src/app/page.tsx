import { newsContent, fallbackNews, fallbackEvents } from "@/data/content";
    ...
    <>
      ...
      <section className="border-y border-stone-200/80 bg-[#f2ebe3]/60 py-14 sm:py-20">
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-10 max-w-2xl text-sm italic leading-relaxed text-stone-600">
      ...
      <section className="relative overflow-hidden bg-accent-900 py-16 sm:py-20 lg:py-24">
        ...
        <div className="relative mx-auto grid max-w-6xl gap-12 px-4 sm:px-6 lg:grid-cols-12 lg:gap-16 lg:px-8">
          <div className="lg:col-span-5 lg:pt-1">
            <p className="text-sm font-medium text-accent-200">Why we exist</p>
          ...
          <div className="flex flex-col justify-center border-t border-white/10 pt-10 lg:col-span-7 lg:border-l lg:border-t-0 lg:border-white/10 lg:pl-14 lg:pt-0">
            <p className="text-[17px] leading-[1.7] text-accent-100/90">
              That is human development in practice. We help governments and civic actors strengthen governance—through
              evidence, training, and patient partnership—so prosperity and dignity are not reserved for the few.
            </p>
      ...
      <section className="border-t border-slate-200 bg-slate-50 py-16 sm:py-20 lg:py-24">
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-start gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h2 className="font-serif text-2xl font-bold text-slate-900">APP Summit</h2>
              <p className="mt-2 text-slate-600">
                Forums and expert roundtables advancing governance excellence across Africa.
              </p>
            </div>
            <Button asChild href="/app-summit" variant="outline">
              Learn More
            </Button>
          </div>
        </div>
      ...
      <section className="border-t border-slate-200 bg-white py-16 sm:py-20 lg:py-24">
        <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="font-serif text-3xl font-bold text-slate-900 sm:text-4xl">{newsContent.title}</h2>
            <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-600">{newsContent.subtitle}</p>
          </div>
          {latestNews.length > 0 ? (
            ...
            <div className="mt-12 rounded-2xl border border-slate-200 bg-slate-50 p-8 text-center">
              <p className="text-slate-600">No news items yet. Check back soon.</p>

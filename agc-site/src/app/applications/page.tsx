  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Your skills and time strengthen research, events, and policy dialogue across the continent. Tell us how you’d like to contribute — we read every submission."
        breadcrumbs={[
          { label: "Home", href: "/" },

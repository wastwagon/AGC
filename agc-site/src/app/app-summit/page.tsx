...
export default function AppSummitPage() {
  const [activeDay, setActiveDay] = useState(0);
  const { details, registration, agenda } = appSummitContent;
  ...
  return (
    <>
      <PageHero
        ...
        title={appSummitContent.title}
        subtitle={appSummitContent.subtitle}
        image={placeholderImages.appSummit}
        imageAlt="APP Summit"
      />

      {/* About + Registration - two columns */}
      <section className="page-section-paper border-b border-stone-200/80 py-16 sm:py-20 lg:py-24">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-3 lg:gap-16">
            <div className="lg:col-span-2">
              <p className="text-sm font-medium text-accent-800">Continental convening</p>
              <h2 className="page-heading mt-2 text-2xl sm:text-3xl">About APP Summit 2025</h2>
              <p className="page-prose mt-4 text-lg">{appSummitContent.intro}</p>
      ...
      <section className="page-section-warm border-t border-stone-200/60 py-16 sm:py-20 lg:py-24">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <p className="text-sm font-medium text-accent-800">Programme</p>
      ...
      <section className="page-section-paper border-t border-stone-200/80 py-16 sm:py-20">
        <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-stone-200/80 bg-[#f2ebe3]/35 p-8 sm:p-10">
            <p className="page-prose">{appSummitContent.contactNote}</p>

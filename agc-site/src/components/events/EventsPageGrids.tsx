...
function EventGrid({ events, isPast }: { events: CmsEvent[]; isPast: boolean }) {
  ...
  return (
    <div className="grid grid-cols-1 gap-px bg-stone-200/90 sm:grid-cols-2 lg:grid-cols-4">
      {events.map((event) => (
  ...
  return (
    <div className="mt-14 space-y-20 lg:space-y-24">
      <section aria-labelledby="events-upcoming-heading">
        <div className="border-t border-stone-200/90 pt-2">
          <h2
            id="events-upcoming-heading"
            className="page-heading text-3xl font-bold tracking-tight text-stone-950 sm:text-4xl"
          >

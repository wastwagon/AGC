...
import type { CmsEvent, CmsEventAgendaItem, CmsTeamMember } from "@/lib/content";
import { eventsContent, siteConfig } from "@/data/content";
import { HomeScrollReveal } from "@/components/home/HomeScrollReveal";
import { getYouTubeEmbedSrc } from "@/lib/youtube-embed";
import { preferUnoptimizedImage } from "@/lib/image-delivery";

const baseUrl = (process.env.NEXT_PUBLIC_SITE_URL || "https://www.africagovernancecentre.org").replace(/\/$/, "");
...
function dateBlockParts(iso: string): { month: string; day: string; year: string } {
  const d = new Date(iso);
